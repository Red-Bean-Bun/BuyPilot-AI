...
async def cancel_chat(body: CancelRequest) -> CancelResponse:
    ...
    persisted_cancelled = await run_sync_io(request_chat_turn_cancellation, body.session_id, body.turn_id)
    ...
    await run_sync_io(
        ...
        metadata={"canceled": canceled, "local_cancelled": local_cancelled, "persisted_cancelled": persisted_cancelled},
    )
